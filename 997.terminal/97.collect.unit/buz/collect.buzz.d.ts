...
export declare const dotCollect: (cpy: CollectModel, bal: CollectBit, ste: State) => CollectModel;
export declare const formatCollect: (cpy: CollectModel, bal: CollectBit, ste: State) => CollectModel;
